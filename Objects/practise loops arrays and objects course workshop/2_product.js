...
function addInventory(productObject, toAdd) {
  
  var summation = productObject.inventory + toAdd;
  console.log(""+toAdd+" "+ productObject.name +"s added to the inventory");
...
function processSale(productObject, soldProduce) {
  var sold = productObject.inventory - soldProduce;
  var totalsale = soldProduce * productObject.unit_price;
  console.log(""+sold+" "+productObject.name+" sold");
  return soldProduce * productObject.unit_price;
}
